"""
Django settings for neoarch project.
...
SECRET_KEY = 'django-insecure-0ru(+nd)&v@topp4-!=53evhltrrb%yi8#nkkl%e0fjy*&ss+c'
...
WSGI_APPLICATION = 'neoarch.wsgi.application'
